...
exports.updateUser = async function (user) {
    ...
    if (user.collegeDegree!=null){
        oldUser.collegeDegree = user.collegeDegree
    }
    if (user.phone!=null){
    ...
    if (user.schooling!=null){
        oldUser.schooling = user.schooling
    }
    if (user.experiences!=null){
        oldUser.experiences = user.experiences
    }
    if (user.courses!=null){
        oldUser.courses = user.courses
    }
